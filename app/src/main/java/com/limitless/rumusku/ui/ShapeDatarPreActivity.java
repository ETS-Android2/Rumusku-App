...
import com.limitless.rumusku.ViewDatarAdapter;
import com.limitless.rumusku.model.DatarModel;

import java.util.ArrayList;

public class ShapeDatarPreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new ViewDatarAdapter.PagerAdapter(getSupportFragmentManager()));
        ...
        img_shpe.setImageResource(preferences.getInt("gambar", 0));
